...
<body>
	...
	<nav class="navbar navbar-inverse navbar-fixed-top">
    	...
    	<ul class="nav navbar-nav">
      		...
      		<li class="active"><a href="Note.jsp"><span class="glyphicon glyphicon-plus"></span> Add Note</a></li>
	  		<li><a href="view"><span class="glyphicon glyphicon-eye-open"></span> Show Notes</a></li>
